...
export class MerlinScanner {
    ...
    private scanToken(): void {
        ...
        switch(c) {
            case "(": this.addToken(MerlinTokenType.LEFT_PAREN); break;
            case ")": this.addToken(MerlinTokenType.RIGHT_PAREN); break;
            case "{": this.addToken(MerlinTokenType.LEFT_BRACE); break;
            case "}": this.addToken(MerlinTokenType.RIGHT_BRACE); break;
            case "[": this.addToken(MerlinTokenType.LEFT_BRACKET); break;
            case "]": this.addToken(MerlinTokenType.RIGHT_BRACKET); break;
            case ",": this.addToken(MerlinTokenType.COMMA); break;
            case ":": this.addToken(MerlinTokenType.COLON); break;
            case ";": this.addToken(MerlinTokenType.SEMICOLON); break;
            case "-": this.addToken(MerlinTokenType.MINUS); break;
            case "+": this.addToken(MerlinTokenType.PLUS); break;
            case "*": this.addToken(MerlinTokenType.STAR); break;
            case ".":
                if (this.match(".")) {
