					...
					content:
						<div>
							<div class="spacingLeft spacingRight">
								<p class="hanging">
									Lewetz, D., & Stieger, S. (2024). ESMira: A decentralized open-source application for collecting experience sampling
									data. <i>Behavior Research Methods</i>, <i>56</i>, 4421-4434.
									<br />
