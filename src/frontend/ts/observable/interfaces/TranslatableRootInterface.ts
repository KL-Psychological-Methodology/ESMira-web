 ...
 * Each {@link Translatable} that is implemented as a container ({@link TranslatableArray} or {@link TranslatableObject})
 ...
 * I also find it clearer when you can define a "head class" so it is obvious that this class and all its children will have the
 * same languages and are handled together.
 */
export interface TranslatableRootInterface {
